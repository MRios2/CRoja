...
<div class="container p.4" style = "margin-top: 50px">
    <div class="col-md 4">
        ...
        <div class="card card-body" style="width: 67%; margin-bottom: 20px">
            <form action="saveCredencializacion.php" method = "POST">
    ...
    <table class = "table table-bordered">
            ...
            <tbody>
                <?php
                    $query = "SELECT * FROM credencializacion";
                    ...
                    while($row = mysqli_fetch_array($result)){ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="deleteCredencializacion.php?id=<?php echo $row['id']; ?>" class = "btn btn-danger">
