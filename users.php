        ...
        <div class="card card-body">
            <form action="savePersonal.php" method = "POST">
                <div class="form-group">
                   ...
                   <div class="form-group">
                   <input type="text" name = "plname" class = "form-control" placeholder = "apellido paterno"> 
                   </div>
                   <div class="form-group">
                   <input type="text" name = "mlname" class = "form-control" placeholder = "apellido materno"> 
                </div>
                <div class="form-group">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($result)){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="editPersonal.php?id=<?php echo $row['id']; ?>">Edit</a>
                                </td>
                            </tr>
