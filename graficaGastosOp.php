...
<html>
    ...
    <body> 
        ...
        <form action="./gastoOp.php">
        <input type="submit" class="btn btn-success" value="Administrar"/>
        </form>
        <!-- <button class="btn btn-success btn-left btn-block">Administrar</button> -->
        </div>
        ...
        <div class="text-center" style = "margin-top: 15px;"><h2> Gastos operativos de noviembre</h2></div>
